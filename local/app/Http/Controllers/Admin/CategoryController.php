...
class CategoryController extends Controller
{
    ...
    public function Lists()
    {
        ...
        ->editColumn('photo',function($rec){
            if($rec->photo == null){
                return $photo = ' <img src="'.asset('uploads/Banner/nophoto.png').'" class="image-full image-btn" width="50%" height="50%" alt="vchinese"/>';
            }else {
                return $photo = ' <img src="'.asset('uploads/Banner/'.$rec->photo).'" class="image-full image-btn" width="50%" height="50%" alt="vchinese"/>';
            }
        })
