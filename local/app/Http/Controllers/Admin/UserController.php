...
class UserController extends Controller
{
    ...
    public function Lists(){
        $result = \App\Models\User::select()->orderBy('id','DESC');
        return \Datatables::of($result)
        ->addIndexColumn()
        ->editColumn('firstname',function($rec){
            return $firstname = $rec->firstname.'  '.$rec->lastname;
        })
        ->editColumn('active_email',function($rec){
            if($rec->active_email == 'T'){
                return $active_email =  '<span class="label label-success">Confirm</span>';
            }else{
                return $active_email =  '<span class="label label-danger">Not confirmed</span>';
            }
        })
