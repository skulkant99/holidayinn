        ...
        <div class="modal-content">
            <form id="FormAdd">
                ...
                {{-- <div class="form-group">
                    ...
                    <input type="text" class="form-control number-only" name="main_menu_id" id="add_main_menu_id"  placeholder="main_menu_id">
                </div> --}}
                ...
                <div class="form-check">
                    <label for="add_show" class="checkbox form-check-label">
                        <input type="checkbox" class="form-check-input" data-toggle="checkbox" name="show" id="add_show"  value="T" checked="checked"> show
                    </label>
                </div>
        ...
        <div class="modal-content">
            ...
            <form id="FormEdit">
                ...
                {{-- <div class="form-group">
                    ...
                    <input type="text" class="form-control number-only" name="main_menu_id" id="edit_main_menu_id"  placeholder="main_menu_id">
                </div>
         --}}
                <div class="form-group">
...
<script>
     ...
     var TableList = $('#TableList').dataTable({
        "ajax": {
            "url": url_gb+"/admin/AdminMenu/Lists",
            "data": function ( d ) {
                //d.myKey = "myValue";
    ...
    $('body').on('click','.btn-edit',function(data){
        ...
        $.ajax({
            ...
            if(rec.show=='T'){
                $('#edit_show').prop('checked','checked').closest('label').addClass('checked');
            }else{
    ...
    $('body').on('click','.btn-delete',function(e){
        ...
        swal({
            ...
            $.ajax({
                method : "POST",
                url : url_gb+"/admin/AdminMenu/Delete/"+id,
                data : {ID : id}
            }).done(function(rec){
                if(rec.status==1){
                    swal(rec.title,rec.content,"success");
