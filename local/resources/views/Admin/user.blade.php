    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form id="FormAdd">
                ...
                <div class="form-group">
                    <label for="add_active_email">active_email</label>
                    <input type="text" class="form-control" name="active_email" id="add_active_email"  placeholder="active_email">
                </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="FormEdit">
                ...
                <div class="form-group">
                    <label for="edit_active_email">active_email</label>
                    <input type="text" class="form-control" name="active_email" id="edit_active_email"  placeholder="active_email">
                </div>
