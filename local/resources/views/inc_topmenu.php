...
<div class="row">
			...
			<div class="overlay" id="overlay">
			  <nav class="overlay-menu">
				<ul>
				  ...
				  <li><a href="<?php echo('gallery') ?>">Photos</a></li>
				  <li><a href="<?php echo('question') ?>">Ask Question</a></li>
	...
	<div class="row topmenu_bar">
		<div class="col-md-3 col-lg-2">
			<div class="mainlogo">
				<a href="index.php"><img src="images/home2-edit_03.png" class="img-fluid"></a>
			</div>
		</div>
		<div class="col-md-9 col-lg-10 nopad">
				<div class="sidetop_right">
				<img src="images/home2-edit_05.png" class="img-fluid kidslogo">
					<li>
...
<button type="button" class="btn btn-dark" data-toggle="modal" data-target="#exampleModalCenter">
  ...
  Register 
				...
				<li><a href="#"><img src="images/social_top_03.png"></a></li>
				<li><a href="#"><img src="images/social_top_05.png"></a></li>
				<li><a href="#"><img src="images/social_top_06.png"></a></li>
				<li><a href="#"><img src="images/social_top_08.png"></a></li>
				<li><a href="#"><img src="images/social_top_10.png"></a></li>
				<li><a href="#"><img src="images/social_top_11.png"></a></li>
				<li><a href="#"><img src="images/social_top_12.png"></a></li>
				<li><a href="#"><img src="images/social_top_14.png"></a></li>
				<li><a href="#"><img src="images/social_top_16.png"></a></li>
				<li><a href="#"><img src="images/social_top_18.png"></a></li>
				<li><a href="#"><img src="images/social_top_19.png"></a></li>
				<li><a href="#"><img src="images/social_top_20.png"></a></li>
				<li><a href="#"><img src="images/social_top_21.png"></a></li>
				<li><a href="#"><img src="images/social_top_22.png"></a></li>
				</div>	
			</div>
		</div>
	</div>
  ...
  <div class="modal-dialog modal-lg  modal-dialog-centered" role="document">
    ...
    <label for="checkboxes-0">
      ...
      Remember me
    			        ...
    			        <div class="row">
    			        	<div class="col-lg-6">
     			        <a href="forgetpassword.php" class="forgotpass">Forget password ?</a>
    			        	</div>
    			        	<div class="col-lg-6 text-right">
    			          New Customer? <a href="#exampleModalCenter2" class="signupnow">Sign up now</a>
