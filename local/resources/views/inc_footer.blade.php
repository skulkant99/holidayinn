		...
		<div class="row">
			...
			<div class="col-lg-4">
				<div class="subscribe">
					...
					<input id="textinput" name="textinput" type="text" placeholder="Enter your email here" class="form-control_sub input-md">
					<br> <a href="#" class="btn btn-primary">Subscribe</a> </div>
			</div>
		</div>
		<div class="hover_box">
