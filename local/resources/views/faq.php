		...
		<div class="row">
			<div class="col">
				<div class="head_title">
					...
					<p>Need immediate assistance? Please call +66 (0) 76 370 200

</p>
				</div>
				<div class="search-container">
						<input type="text" id="search-bar" placeholder="Search by brand or keyword"> <a href="#"><img src="images/search.png" class="search-icon"></a> </div>
			</div>
		</div>
	</div>
	...
	<br>
		<div class="container">
			<div class="row">
				<div class="col">
					<ul class="accordion">
							<li> <a>What process should I follow if I would like to shop with Huskies Online Shopping?</a>
								<p>	
You could shop with Huskies Online Shopping by following these 3 easy steps: 1. Login at Huskiesbags website 2. Shop 3. Select payment and shipping method</p>
							</li>
